...
import (
	apiscnatv1alpha1 "Kubernetes_Programming/pkg/apis/cnat/v1alpha1"
	versioned "Kubernetes_Programming/pkg/generated/clientset/versioned"
	internalinterfaces "Kubernetes_Programming/pkg/generated/informers/externalversions/internalinterfaces"
	cnatv1alpha1 "Kubernetes_Programming/pkg/generated/listers/cnat/v1alpha1"
	context "context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CnatV1alpha1().Ats(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CnatV1alpha1().Ats(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CnatV1alpha1().Ats(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CnatV1alpha1().Ats(namespace).Watch(ctx, options)
			},
		}, client),
		&apiscnatv1alpha1.At{},
		resyncPeriod,
